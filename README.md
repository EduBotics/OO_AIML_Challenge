A set of challenges to be coded. (Aimed particularly at Python, but any language will do; ideally one with built-in OO syntax, but even that's not a requirement!)
