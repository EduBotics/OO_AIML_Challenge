A set of challenges to exercise programming skills. (Aimed particularly at Python, but any language will do; ideally one with built-in OO syntax, but even that's not a requirement!)
